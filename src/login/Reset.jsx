      ...
      <div className="w-full max-w-[440px] space-y-8">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          ...
          <div>
            <button
              type="submit"
              className="flex w-full justify-center rounded-xl bg-[#3B82F6] px-4 py-4 text-base font-semibold text-white shadow-sm hover:bg-blue-600 transition-colors"
            >
              Update Password
            </button>
          </div>
        ...
        <div className="text-center">
          <Link to="/" className="text-base font-medium text-[#3B82F6] hover:underline">
            Back to Login
          </Link>
        </div>
