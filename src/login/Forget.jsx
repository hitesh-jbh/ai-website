...
export default function ForgotPassword() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Sending recovery link to email:', email);
    setIsSent(true);
  };
    ...
    <div className="flex min-h-screen items-center justify-center bg-white px-6 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-[440px] space-y-8 animate-in fade-in duration-200">
        ...
        {!isSent ? (
          <>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-6">
              <div className="space-y-2">
                <label className="block text-base font-bold text-[#1E293B]">
          ...
          <div className="text-center space-y-6 animate-in scale-in duration-200">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl font-black text-[#1E293B]">Check your email</h2>
              <p className="text-base text-[#64748B] font-medium">
        ...
        <div className="text-center pt-4">
          <Link to="/" className="inline-flex items-center gap-2 text-base font-bold text-[#3B82F6] hover:underline">
